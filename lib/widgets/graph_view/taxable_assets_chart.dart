...
class TaxableAssetsChart extends StatefulWidget {
  final String chartTitle;
  final List<ScenarioResult> scenarioResults;
  const TaxableAssetsChart(
      {required this.chartTitle, required this.scenarioResults, super.key});

  @override
  State<TaxableAssetsChart> createState() => _TaxableAssetsChartState();
}

class _TaxableAssetsChartState extends State<TaxableAssetsChart> {
  ...
  Widget build(BuildContext context) {
    return buildChart(
      ...
      yValueMapper: (YearResult yearResult, _) => yearResult.taxableAssets,
    );
  }
}
