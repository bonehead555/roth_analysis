...
class RothAssetsChart extends StatefulWidget {
  final String chartTitle;
  final List<ScenarioResult> scenarioResults;
  const RothAssetsChart(
      {required this.chartTitle, required this.scenarioResults, super.key});

  @override
  State<RothAssetsChart> createState() => _RothAssetsChartState();
}

class _RothAssetsChartState extends State<RothAssetsChart> {
